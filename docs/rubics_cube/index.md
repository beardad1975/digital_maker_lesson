...
: <sup>( 資料來源:</sup>[^rounded_corner]<sup>)</sup>
...
: ![倒角及圓角按鈕](chamder_fillet_button.jpg)
...
: <sup>(資料來源:</sup>[^three_view]<sup>)</sup>
...
: <sup>( 資料來源:</sup>[^fold_paper]<sup>)</sup>
